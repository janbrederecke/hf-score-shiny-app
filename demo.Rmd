---
title: "Demo File for the HF Score App Prototype"
...
This file demonstrates BASIC functionality of a Shiny app that will be used for
HF prediction as soon as the prediction algorithm has been finalized (calibrated,
validated externally etc.).

Looks and functionality can and will be improved as this is only a
"proof of concept".

This app will be used like a normal webpage with interactive functionality and
will be made available with the respective article on the HF score.

All texts are placeholders for the sole purpose of demonstration.
...
ui <- fluidPage(theme = shinytheme("cosmo"),
                setBackgroundImage(src = "https://drive.google.com/uc?id=1qdoowwru1IBPzlRZh-HBI-eKMEUN82_Y"),
